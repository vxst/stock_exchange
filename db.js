...
exports.init_database = function(){
	pool.getConnection(
		function(err, connection){
			connection.query("CREATE TABLE IF NOT EXISTS users(id INT PRIMARY KEY AUTO_INCREMENT, username VARCHAR(32), name VARCHAR(32), password CHAR(20), password_salt CHAR(4), date TIMESTAMP, national_id VARCHAR(32), address VARCHAR(255), work VARCHAR(32), education VARCHAR(32), work_phone VARCHAR(32), is_admin BOOLEAN)");
